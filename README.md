## **This is the Seattle Solver's code for the FLL 2022-23 season, Superpowered.**
...
- All of the innovation project app code is in ```Kotlin```, with the UI made with ```Extensible Markup Language``` made with Android Studio. The code for our blinds app is is in a [seperate ithub repository](https://github.com/Vision1nil/SmartBlinds-App).
---
